...
public class ProcessoSeletivo {
    public static void main(String[] args) {
        ...
        static void entrandoEmContato (String candidato) {
            ...
            if(atendeu)
                ...
                System.out.println("NAO CONSEGUIMOS COM " + candidato + " NÚMERO MÁXIMO DE TENTATIVAS " + tentativasRealizadas + " REALIZADAS.");
        }
    ...
    static void selecaoCandidatos() {
        ...
        while (candidatosSelecionados < 5 && candidatoAtual < candidatos.length) {
            ...
            System.out.println("O candidato " + candidato + " Solicitou o valor salário de: " + salarioPretendido);
